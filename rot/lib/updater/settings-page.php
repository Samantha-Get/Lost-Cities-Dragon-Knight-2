		...
		<div id="ithemes-updater-settings">
			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						<th scope="row">
							<label for="quick_releases"><?php _e( 'Quick Release Updates', 'it-l10n-rotating-images' ); ?></label>
						</th>
						<td>
...
?>
	<div class="ithemes-updater-products" id="ithemes-updater-unrecognized">
		...
		<p><?php printf( __( 'Please check this page again at a later time to see if the problem resolves itself. If the product remains, please contact <a href="%s">iThemes support</a> and provide them with the details given below.', 'it-l10n-rotating-images' ), 'http://ithemes.com/support/' ); ?></p>
