...
////////////////////////////
// Here you can change the value of cash. 40 gold is default value which is needed to play the game.
////////////////////////////

$cash = 40;

if ($cash > $userrow["gold"]) {display("You dont have enough money to play!<br><a href=\"index.php?\" class=\"myButton2\">Back to Town Square</a>", "Lottery"); die(); }
...
if($guess11 == "" || $guess22 == "" || $guess33 == "" || $guess44 == "" || $guess55 == "") {display("You must choose 5 numbers!!!<br><a href=\"index.php?do=loteri\" class=\"myButton2\">Back</a>", "Lottery"); die(); }
...
$page = '<center>';
$page .= '<h3 class="title">The {{innsname}} {{name}} Lottery</h3>';
$page .= '<i>You got 1 number right = 0 gold<br>
You got 2 number right = 20 gold<br>
You got 3 number right = 300 gold<br>
You got 4 number right = 1000 gold<br>
You got 5 number right = 3000 gold<br>
</i><br>';
$page .= '<table>';
$page .= '<tr>
...
$page .= '</center><a href=\'index.php\' class=\'myButton2\'>Back to Town Square</a> or <a href=\'index.php?do=loteri\' class=\'myButton2\'>Play Again</a>';
...
<p>';
	...
	$page .= '<input type=submit value=OK name=buy></form><br><i><b>To play you need 40 Gold Coins.</b></i>';
	$page .= '<a href=\'index.php\' class=\'myButton2\'>Back to Town Square</a></center>';
