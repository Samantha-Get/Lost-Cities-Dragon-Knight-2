...
END;
    ...
    $pagearray["command"] = "You have died.<br /><br />As a consequence, you've lost half of your gold. However, you have been given back a portion of your hit points to continue your journey.<br /><br />You may now continue back to <a href=\"index.php\">town</a>, and we hope you fair better next time.";
}
    ...
    if ($userrow["level"] < 300) {
        if ($newexp >= $levelrow[$userrow["charclass"]."_exp"]) {
            ...
            if (rand(1,30) == 1) {
                ...
                $dropcode = "";
                $page .= "<font color=\"#804000\">You can now continue [templates/fightspawn.php 477]</font><a href=\"index.php\">exploring</a>.";
            }
...
function drop() {
    ...
    if (isset($_POST["submit"])) {
        ...
        $page = "The item has been equipped. <font color=\"#804000\">You can now continue [templates/fightspawn.php 553]</font> <a href=\"index.php\">exploring</a>.";
...
function dead() {
    ...
    $page = "You have died.<br /><br />As a consequence, you've lost half of your gold. However, you have been given back a portion of your hit points to continue your journey.<br /><br />You may now continue back to <a href=\"index.php\">town</a>, and we hope you fair better next time. Remember your fifth death is your final death. You body will be forever be laid to rest in the town graveyard.";
