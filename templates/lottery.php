...
display($page, "The Lottery [ Lottery ]");
}
...
$histoquery = doquery("SELECT gains, date FROM {{table}} ORDER BY date DESC LIMIT 20", "loto" );
$page = "<center><br /><br><img src='images/lottery/dice1.jpg' /><br><br><a href='index.php?do=history_lottery' class='myButton2'>Lottery History</a>&nbsp;&nbsp;<a href='index.php?do=lottery_presentation' class='myButton2'>Lottery</a>&nbsp;&nbsp;&nbsp;<a href='index.php?do=town' class='myButton2'>Town</a></center><br /><br /><div align='center'><table width='50%'><tr><td align='center' colspan='2'><div align='center'><h3 class='title'>Last 20 Players</h3></div></td></tr>
";
...
display($page, "The Lottery [ Lottery History ]");
