...
<center><blockquote><blockquote><form action="login.php?do=login" method="post"><table align="center">
...
<tr><td colspan="2"><center><input type="submit" name="submit" value="Log In" class="myButton2" /></center><br></td></tr>
