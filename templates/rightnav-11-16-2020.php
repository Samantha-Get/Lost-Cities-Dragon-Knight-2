...
<table border="1" cellpadding="4" cellspacing="2" width="100%">
<tr>
<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=buy'>Weapon:</a></span></td></tr><tr>
<td><img src="imag/{{weaponname}}.png" alt="{{weaponname}}" title="{{weaponname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=wea1'>Range Weapons:</a></span></td></tr><tr>
<td><img src="imag/{{rangeweaponsname}}.png" alt="{{rangeweaponsname}}" title="{{rangeweaponsname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=ghmk'>Gauntlet:</a></span></td></tr><tr>
<td><img src="imag/{{gauntletname}}.png" alt="{{gauntletname}}" title="{{gauntletname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=pxcu'>Pet:</a></span></td></tr><tr>
<td><img src="imag/{{petname}}.png" alt="{{petname}}" title="{{petname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=amro'>Armor:</a></span></td></tr><tr>
<td><img src="imag/{{armorname}}.png" alt="{{armorname}}" title="{{armorname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=loja'>Shield:</a></span></td></tr><tr>
<td><img src="imag/{{shieldname}}.png" alt="{{shieldname}}" title="{{shieldname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=hzrt'>Helmet:</a></span></td></tr><tr>
<td><img src="imag/{{helmetname}}.png" alt="{{helmetname}}" title="{{helmetname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=bmnn'>Boot:</a></span></td></tr>
<td><img src="imag/{{bootname}}.png" alt="{{bootname}}" title="{{bootname}}" /></td></tr><tr>

<td width="100%"><span style="font-family: verdana; font-weight: normal; font-style: normal; text-decoration: none; font-size: 8pt;"><a href='index.php?do=wea2'>Magic Rings:</a></span></td></tr>
<td><img src="imag/{{magicringsname}}.png" alt="{{magicringsname}}" title="{{magicringsname}}" /></td></tr><tr>
</table>
</span>
<br /><br />
