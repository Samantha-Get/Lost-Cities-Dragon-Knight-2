...
///SAFE NR
$safecode1 = rand(5,5); // Change this to 1,1 or 2,2 etc for 1 only safe code, or random 1-5
$safecode2 = rand(10,10);  // Change this to 6,6 or 7,7 etc for 1 only safe code, or random 6-10
$safecode3 = rand(15,15);  // Change this to 11,11 or 12,12 etc for 1 only safe code, or random 11-15
$safecode4 = rand(20,20);  // Change this to 11,11 or 12,12 etc for 1 only safe code, or random 16-20
$safecode5 = rand(25,25);  // Change this to 11,11 or 12,12 etc for 1 only safe code, or random 21-25
...
doquery("UPDATE {{table}} SET bankgold='$bankgold/200' WHERE id='".$userrow["id"]."' LIMIT 1", "users");
$page .= "<center><h3 class='title'>{{towncityname}} {{banksname}}<h3></center>";
$page .="<br /><blockquote><blockquote>Well Done! You have opened the Code. You find $bankgold Gold Coins in side the Safe</blockquote></blockquote>";
...
$page .= "<br />The Chase continues for what seems like hours, then the Guard has you in sight and yells <em>STOP AND DROP THE GOLD</em>. <br><br>You smile back at him and throw a couple of knives towards his direction. The Guard then yells <em>Stop or you will regret it!</em> You return his threat with a couple of more knives that miss the guard again. The Guard then hits you in the leg and upper chest with his own knives.<br><br>You will live to see another day, but you have lost all but 2 Hit Points, 2 Magic Points, 5 Travel Points and need to rest at the Inn. If were lucky this time and will be able to continue your exploring again.</blockquote></blockquote>";
...
$page .= "<center><h3 class='title'>{{towncityname}} {{banksname}}<h3></center>";
$page .= "<br /><blockquote><blockquote><center><img src='images/items/gold-coins-large.png' align='absmiddle' width='72' height='72' alt='Gold Coins' border='0'>This bank has $bankgold Gold Coins in its Vault. <form action=index.php?do=robb method=post><input type='submit' value='Robb the Bank' name='steal' class='myButton2'></form></center><br />";
