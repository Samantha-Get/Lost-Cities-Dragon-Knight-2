...
$page .= "<table width=100% align=center><tr><td colspan=4 align=center bgcolor=#dddddd>";
...
$page .= "<table width=100% align=center><tr><td bgcolor=#eeeeee width=40%>";
$page .= "$locked$sticky <a href=forum.php?do=thread:".$row["id"].":0 title='View this thread!'><font color=#0000ff>".$row["title"]."</font></a>";
$page .= "</td><td align=center width=20% bgcolor=#eeeeee>";
$page .= "<a href=\"index.php?do=onlinechar:".$row["authorid"]."\" title='View this characters profile'>".$row["author"]."</a>";
$page .= "</td><td align=center width=10% bgcolor=#eeeeee>";
$page .= "<font color=#000000>".$row["replies"]."</font> ";
$page .= "</td><td align=center width=10% bgcolor=#eeeeee>";
$page .= " <font color=#000000>".$row["views"]."</font> ";
$page .= "</td><td align=center width=20% bgcolor=#eeeeee>";
...
$page .= "<img src=".$forumcontrolrow["avatar_path"]."".$forumusersrow["forumavatar"]." width=50 height=50 border=0>";
$page .= "</td><td >";
$page .= "$rights_display";
...
$page .= "<img src=".$forumcontrolrow["avatar_path"]."".$row["forumavatar"]." width=50 height=50 border=0>";
$page .= "</td><td bgcolor=#dddddd>";
$page .= "$rights_display";
$page .= "</td></tr><tr><td colspan=2 bgcolor=#dddddd>";
$page .= "Hit Points:<br />";
$page .= "</td></tr></table>";
$page .= "</td><td align=left colspan=2 bgcolor=#dddddd><br>";
...
$page .= "</td><td bgcolor=#eeeeee>";
$page .= "$rights_display";
$page .= "</td></tr><tr><td colspan=2 bgcolor=#eeeeee>";
$page .= "Hit Points:<br />";
$page .= "</td></tr></table>";
$page .= "</td><td colspan=2 bgcolor=#eeeeee><br>";
$page .= "<font color=#000000>".nl2br($row["content"])."</font>";
$page .= "<br></td></tr></table>";
$page .= "<hr width=100%>";
$count = 1; } }
...
$page .= "<font color=#000000>:p &nbsp;=&nbsp;</font><img src=".$forumcontrolrow["image_smilies_path"]."tongue.png><br />";
$page .= "<font color=#000000>:) &nbsp;=&nbsp;</font><img src=".$forumcontrolrow["image_smilies_path"]."smile.png><br />";
$page .= "<font color=#000000>:( &nbsp;=&nbsp;</font><img src=".$forumcontrolrow["image_smilies_path"]."frown.png><br />";
$page .= "<font color=#000000>;) &nbsp;=&nbsp;</font><img src=".$forumcontrolrow["image_smilies_path"]."wink.png><br />";
$page .= "<font color=#000000>-.- &nbsp;=&nbsp;</font><img src=".$forumcontrolrow["image_smilies_path"]."sleep.png><br />";
$page .= "</td></tr></table>";
$page .= "<hr width=100%>"; }
else { 
