...
////////////////////////////
// Here you can change the value of cash. 50 gold is default value which is needed to play the game.
////////////////////////////

$cash = 50;

if ($cash > $userrow["gold"]) {display("You dont have enough money to play!<br><a href=\"index.php?\">Back to Town Square</a>", "Lottery50"); die(); }
...
$page = '<center>';
$page .= '<h3 class="title">{{innsname}} Lottery 50</h3>';
$page .= '<br><br>You got 1 number right = 0 Gold Coins<br>
You got 2 number right = 50 Gold Coins<br>
You got 3 number right = 300 Gold Coins<br>
You got 4 number right = 1600 Gold Coins<br>
You got 5 number right = 3200 Gold Coins<br>
<br>';
$page .= '<table>';
$page .= '<tr>
...
$page .= '<a href=\'index.php\'>Back to Town Square</a> or <a href=\'index.php?do=loteri50\'>Play Again</a></center>';

	display($page, "Lottery50");
...
$page .= '<form action=index.php?do=loteri50 method=post>
...
<p>';
	...
	$page .= '<input type=submit value=OK name=buy></form><br><i>To play again you need 50 Gold Coins</i>';
