...
////////////////////////////
// Here you can change the value of cash. 100 gold is default value which is needed to play the game.
////////////////////////////

$cash = 50;

if ($cash > $userrow["gold"]) {display("You dont have enough money to play!<br><a href=\"index.php?\">Back to Town Square</a>", "Lottery100"); die(); }
...
$page = '<center>';
$page .= '<h3 class="title">{{innsname}} Lottery 100</h3>';
$page .= '<br><br>You got 1 number right = 0 Gold Coins<br>
You got 2 number right = 100 Gold Coins<br>
You got 3 number right = 600 Gold Coins<br>
You got 4 number right = 3200 Gold Coins<br>
You got 5 number right = 8000 Gold Coins<br>
<br>';
$page .= '<table>';
$page .= '<tr>
...
$page .= '<a href=\'index.php\'>Back to Town Square</a> or <a href=\'index.php?do=loteri100\'>Play Again</a></center>';

	display($page, "Lottery100");
...
$page .= '<form action=index.php?do=loteri100 method=post>
...
<p>';
	...
	$page .= '<input type=submit value=OK name=buy></form><br><i>To play again you need 100 Gold Coins</i>';
