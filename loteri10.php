...
if ($cash > $userrow["silver"]) {display("<center><blockquote>You need 10 Silver Coins to Play!<br /><br />
<br /><br /><center><a href=index.php?do=loteri10 class=myButton2>Play Again</a>&nbsp;&nbsp;<a href=index.php?do=banksilver class=myButton2>Silver Bank</a>&nbsp;&nbsp;<a href=index.php class=myButton2>Town Square</a></center>                                                                                                                                              ", "Lottery10"); die(); }
...
$page = '<center>';
$page .= '<h3 class="title">{{innsname}} Lottery 10</h3>';
$page .= '<br><br>
...
<tr valign=top><td><div style=text-align: left;>2 number right = 10 Silver Coins</div</td></tr>
<tr valign=top><td><div style=text-align: left;>3 number right = 60 Silver Coins</div</td></tr>
<tr valign=top><td><div style=text-align: left;>4 number right = 320 Silver Coins</div</td></tr>
<tr valign=top><td><div style=text-align: left;>5 number right = 800 Silver Coins</div</td></tr>
</table>
</center></div>
<br>';
$page .= '<table>';
...
$page .= '<center><blockquote><a href=index.php?do=loteri10 class=myButton2>Play Again</a>&nbsp;&nbsp;<a href=index.php?do=banksilver class=myButton2>Silver Bank</a>&nbsp;&nbsp;<a href=index.php class=myButton2>Town Square</a></blockquote></center>';
...
$page .= '<form action=index.php?do=loteri10 method=post>
...
<br>';
	...
	$page .= '<input type=submit value=OK name=buy class=myButton2></form><br><center><blockquote>10 Silver Coins to Play.';
	$page .= '<br><br><center><blockquote><a href=index.php?do=loteri10 class=myButton2>Play Again</a>&nbsp;&nbsp;<a href=index.php?do=banksilver class=myButton2>Silver Bank</a>&nbsp;&nbsp;<a href=index.php class=myButton2>Town Square</a></blockquote></center>';
